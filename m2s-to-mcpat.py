...
# global variable to keep track of what section we are parsing now
...
def parser( line, results_sections ):
    ...
    if section_title:
        ...
        # we create a new pair into the results_sections dictionary, where
        ...
        results_sections[section_title.group(1).strip()] = {}
    ...
    # otherwise we are still inside a section
        ...
        try:
            ...
            if current_section is not None:
                results_sections[current_section][param_name.strip()] = param_value.strip()
...
if __name__ == '__main__': #this is how the main function is called in python
    ...
    results_sections = {} # this dictionary will contain one row per every section in the m2s results file
